...
import atu.ExamFrameOptions.EditExam;
 ...
 * @author alber
 */
public class EditDeleteBooking extends javax.swing.JFrame {
    ...
    int rowSelected = tableBooking.getSelectedRowCount(); 
       if (rowSelected == 1) { 
           int indexRow = tableBooking.getSelectedRow(); 
           int idBooking = (int)tableBooking.getModel().getValueAt(indexRow, 0);
           EditBooking editBooking = new EditBooking(idBooking);
    ...
    private void deleteAccountActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteAccountActionPerformed
        ...
        if (rowSelected == 1) { 
            int indexRow = tableBooking.getSelectedRow(); 
            int idModule = (int)tableBooking.getModel().getValueAt(indexRow, 0);
            String sql = "DELETE FROM booking WHERE id = ?";
            Object[] parametersSQL = {idModule};

            int choice = JOptionPane.showConfirmDialog(this, "Are you sure delete Booking and all reference?", "Confirmation", JOptionPane.YES_NO_OPTION);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditDeleteBooking.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditDeleteBooking().setVisible(true);
            }
        });
    }
    ...
    private void loadBooking(){
        ...
        try {
            ...
            for (Map<String, Object> map : result) {
                tableModel.addRow(new Object[]{map.get("id"), map.get("name"), map.get("max_slot")});
            }
        } catch (Exception e) {
